...
RSpec.describe GpsPointRepository do
  subject do
    GpsPointRepository.new(
      start_timestamp: '2015-05-26 08:40:00',
      duration_seconds: 30,
      points: [
        [-121.786952,36.811302,-30.95],
        [-121.786936,36.811311,-31.19],
        [-121.786929,36.811339,-29.00]
      ]
    )
  end
  ...
  describe "#find" do
    it "returns the closest (by recency) recorded lat/long pair" do
      expected_coordinate = [-121.786952,36.811302,-30.95]
      ...
      expected_coordinate = [-121.786936,36.811311,-31.19]
      ...
      expected_coordinate = [-121.786929,36.811339,-29.00]
